...
text_hi = "भारत मेरा देश है, और हमें विविधता में एकता पर गर्व है। भारतमेरादेश है, और हमेंविविधतामेंएकता पर गर्व है।"
...
txt = mp.TextClip(
    text=multiline_text,
    font=DEVANAGARI_FONT_PATH,    # or LATIN_FONT_PATH
    font_size=FONT_SIZE,
    color="white",
    method="label",               # we've already wrapped lines; "label" respects \n
)
...
txt = txt.with_position((x, y)).with_duration(5)
